...
public class NPCSequenceAndMovement : MonoBehaviour {
    ...
    [SerializeField]
    protected float movementDelay = 0.5f;  // Delay per far partire il movimento dopo l'inizio dell'animazione Walking
    ...
    [SerializeField] protected AudioClip[] audioClips; // Array di tracce audio: [0] per la spiegazione iniziale, [1] per la spiegazione dopo la masticata
    ...
    protected bool startMovement = false;  // Diventa true dopo il delay post-Walking

    /// <summary>
    /// Avvia la spiegazione iniziale: attiva l'animazione Greetings e riproduce il primo audio.
    /// </summary>
