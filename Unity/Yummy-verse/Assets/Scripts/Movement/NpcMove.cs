...
public class NPCSequenceAndMovement : MonoBehaviour {
    ...
    [SerializeField] public Movimenti Movimento;

    [Header("Animazioni")]
    [SerializeField] private float greetingDuration = 2f;
    // Non usiamo talkingDuration e delay fissi; usiamo la sincronizzazione via WaitUntil

    [Header("Movement Delay")]
    [SerializeField] private float movementDelay = 0.5f; // Delay per far partire il movimento dopo l'inizio dell'animazione Walking
