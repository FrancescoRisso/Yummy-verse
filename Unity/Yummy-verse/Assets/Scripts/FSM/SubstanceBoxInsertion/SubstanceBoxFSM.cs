...
public class SubstanceBoxParam {
	...
	public Action<Action<GameObject>> _addInsertIntoBoxListener;
	...
	public SubstanceBoxParam(MonoBehaviour mono_behaviour, GameObject game_object, Action<Action<GameObject>> addInsertIntoBoxListener,
...
public class SubstanceBoxFSM : FSM<SubstanceBoxState, SubstanceBoxParam> {
	...
	public Action<GameObject> InsertIntoBox;
	...
	private void AddInsertIntoBoxListener(Action<GameObject> handler) {
