...
public class StomachParameter {
	...
	public StomachParameter(PlaneLowering acid_plane, PercentageToggleManager doors, SceneReference next_scene, MonoBehaviour monoBehaviour,
		StomachFSM stomachFsm, Trigger exit_trigger) {
...
public class StomachFSM : FSM<StomachState, StomachParameter> {
	...
	protected override StomachParameter GetParams() {
		return new StomachParameter(_acid_plane, _doors, _next_scene, this, this, _exit_trigger);
	}
}
