...
public class SubstanceBoxLights : MonoBehaviour {
    ...
    // 🔹 Aggiunta: Lista delle forme che possono essere inserite in questa scatola
    [SerializeField] private List<Shape> _acceptedShapes;
    ...
    // 🔹 Metodo aggiornato per verificare se la forma è accettata
    public bool IsShapeAccepted(Shape shape) {
        return _acceptedShapes.Contains(shape);
    }
}
